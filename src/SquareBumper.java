...
public class SquareBumper implements Gadget {
    ...
    private final Circle topLeftCorner, topRightCorner, bottomLeftCorner,
            bottomRightCorner;
     ...
     * 
     * Abstraction function: represents a square bumper with a specific location
     * on the board Rep invariant: xCor and yCor are in [0,19]
     * 
     * Size and shape: a square shape with edge length 1L Orientation: not
     * applicable (symmetric to 90 degree rotations) Coefficient of reflection:
     * 1.0 Trigger: generated whenever the ball hits it Action: none, just
     * adjusts the ball's velocity
     * 
     */
    ...
    public double getMinCollisionTime(Ball ball) {
        Circle[] circles = new Circle[] { topLeftCorner, topRightCorner,
                bottomLeftCorner, bottomRightCorner };
        LineSegment[] lineSegments = new LineSegment[] { top, bottom, left,
                right };
    ...
    public void interactWithBall(Ball ball) {
        ...
        if (ballWillCollideWith instanceof LineSegment) {
            // reflectWall(LineSegment line, Vect velocity, double
            // reflectionCoeff)
