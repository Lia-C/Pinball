 ...
 * 
 * Bounding box of size 1Lx1L Default orientation (0 degrees) places corners in
 * the northeast, northwest, and southwest. Requires that orientation is 0, 90,
 * 180, or 270. Coefficient of reflection: 1.0
 */

public class TriangleBumper implements Gadget {
    private final int xCor, yCor, orientation; // orientation must be 0, 90,
                                               // 180, or 270
    private final LineSegment leftLeg, rightLeg, hypotenuse; // leftLeg goes
                                                             // from baseCorner
                                                             // to leftCorner
                                                             // rightLeg goes
                                                             // from baseCorner
                                                             // to rightCorner
    private final Circle baseCorner, leftCorner, rightCorner; // baseCorner is
                                                              // the corner
                                                              // opposite the
                                                              // hypotenuse.
                                                              // leftCorner,
    ...
    public void interactWithBall(Ball ball) {
        LineSegment[] lineSegments = new LineSegment[] { leftLeg, rightLeg,
                hypotenuse };
