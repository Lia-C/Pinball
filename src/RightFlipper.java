 ...
 * 
 * Bounding box of size 2Lx2L The flipper's pivot point is in the northeast
 * corner of its bounding box, and its initial rotation is clockwise for the
 * default orientation (0 degrees). Requires that orientation is 0, 90, 180, or
 * 270. Coefficient of reflection: 0.95 Rotates 90 degrees when triggered.
 */
